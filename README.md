# EasyPlan 🪐 - **意图驱动**的智能任务管理工具 (v1.2.2)
...
- **原生任务闭环**：剥离繁重的外部依赖，内置对标专业 Todo 应用的专属任务面板，打造“规划 -> 拆解 -> 执行”的极简全包围体验。
...
### 🔜 v1.2.3 (视野控制与微调 - *当前开发重点*)
- **视野控制 (Scope Horizon)**：针对宏大目标仅规划“启动阶段”，坚守两级扁平化以降低认知负荷。
- **动态迷雾解锁 (Fog of War)**：完成当前阶段后，AI 主动介入动态解锁下一阶段。
- **大模型降级与限流**：深度优化大模型的高并发限制与降级策略。
