...
- **任务级行动教练**：针对单个任务提供“帮我开始”“我卡住了”“拆得更细”，先预览结构化建议，确认后再局部应用。
...
DeepSeek 是当前主验收 Provider。当前 strict Planning Eval 发布基线为：
...
独立 Task Assist Eval 为 **18/18**，JSON、模式匹配、可执行性、范围、引用完整性和显式约束保留六项指标均为 **100%**。
...
- 短期交付支持交付物、时间预算、范围取舍和关键路径。
- 探索决策支持结构化判断、信息缺口、低成本实验和决策门槛。
- 历史计划保持兼容，DeepSeek strict Planning Eval 为 54/54。

### v1.3.0 - Task Copilot / Action Coach

- 围绕单个任务提供“帮我开始”“我卡住了”“拆得更细”的结构化建议。
